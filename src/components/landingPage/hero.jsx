    ...
    <div className={styles.heroContainer}>
      <div className={styles.heroText}>
        ...
        <div className={styles.heroParagraph}>
            <p>
            Discover compassionate, expert-led therapy tailored to your unique needs. At Serenica, we're here to guide you toward healing, growth, and lasting wellness in a supportive and inclusive environment.
            </p>
        </div>
        <div>
